...
function Hobbys(){
    ...
    return(
        <div>
            ...
            <div className="grid grid-cols-4 gap-x-10 gap-y-20 mt-15 w-fit mx-auto text-[30px]">

            <div className="w-fit mx-auto">
                <img src={musiclogo} alt="Listing to Music" className="mx-auto w-30" />
                <p className="w-fit mx-auto">Listing to Music</p>
            </div>

            <div className="w-fit mx-auto">
                <img src={longboardlogo} alt="Longboarding" className="w-30 " />
                <p className="w-fit mx-auto">Longboarding</p>
            </div>

            <div className="w-fit mx-auto">
                <img src={pcbuildinglogo} alt="PC building" className="w-30 " />
                <p className="w-fit mx-auto">PC building</p>
            </div>

            <div className="w-fit mx-auto">
                <img src={gaminglogo} alt="Gaming" className="w-30 " />
                <p className="w-fit mx-auto">Gaming</p>
            </div>

            <div className="w-fit mx-auto">
                <img src={billiardslogo} alt="Pool" className="w-30 " />
                <p className="w-fit mx-auto">Playing 8 ball pool</p>
            </div>

            <div className="w-fit mx-auto">
                <img src={bowlinglogo} alt="Bowling" className="w-30 " />
                <p className="w-fit mx-auto">Bowling</p>
            </div>

            <div className="w-fit mx-auto">
                <img src={grillinglogo} alt="Grilling" className="w-30 " />
                <p className="w-fit mx-auto">Grilling</p>
            </div>

            <div className="w-fit mx-auto">
                <img src={cookinglogo} alt="Cooking" className="w-30 " />
